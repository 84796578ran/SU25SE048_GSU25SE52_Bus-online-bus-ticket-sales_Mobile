...
//
//     List<Map<String, dynamic>> buildTripSeats(dynamic tripOrTransfer, Seat? seat1, Seat? seat2) {
...
//       outbound,
//       widget.bookingData.selectedFirstSeat,
//       widget.bookingData.selectedSecondSeat,
//     );
//     final List<Map<String, dynamic>> inboundSeats = widget.bookingData.isRoundTrip && inbound != null
//         ? buildTripSeats(inbound, widget.bookingData.returnSelectedFirstSeat, widget.bookingData.returnSelectedSecondSeat)
//         : <Map<String, dynamic>>[];
//
...
//     final Seat? returnSeat1 = widget.bookingData.returnSelectedFirstSeat;
//     final Seat? returnSeat2 = widget.bookingData.returnSelectedSecondSeat;
...
//   }
//
//   Widget _buildDirectTripInfo(BuildContext context, String title, Trip trip, Seat? selectedSeat, dynamic stations) {
//     return Card(
//       elevation: 4,
//       child: Padding(
//         padding: const EdgeInsets.all(16.0),
